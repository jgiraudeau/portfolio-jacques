...
const API_BASE_URL =
  process.env.NEXT_PUBLIC_WORDPRESS_RAG_URL?.replace(/\/$/, '') ||
  'https://assistant-wordpress-rag-production.up.railway.app'

const AUTH_STORAGE_KEY = 'portfolio-wordpress-rag-auth'

const starterQuestions = [
  'Comment installer et configurer Astra pour un site vitrine ?',
  'Comment créer une page avec Spectra dans WordPress ?',
  'Comment améliorer le référencement avec Yoast SEO ?',
]
  ...
  return [
    {
      ...
      role: 'assistant',
      content:
        'Bonjour, je suis prêt. Posez une question sur WordPress, Astra, Spectra, Yoast SEO ou les documents indexés.',
    },
  ]
}

export default function AssistantWordPressClient() {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.shell}>
        ...
        <section className={styles.chatPanel} aria-label="Conversation assistant WordPress">
          ...
          <form className={styles.composer} onSubmit={handleAsk}>
            <textarea
              ...
              placeholder="Votre question sur WordPress"
              rows={2}
              disabled={!isAuthenticated || isSending}
            />
